...
\end{remark}
\section{Well-posedness of the optimization problem. Existence of an optimum}
...
\eqref{constr y0} in the case $\gamma =0$. The control-to-observation operator is denoted by
\[
