...
\begin{lemma}\label{lemyyx2}
 Let $T > 0$, $y \in \B$ and $z \in \B$, then there exists a $c>0$ such that
 \[
...
\be\label{ineqqnorm}
\norm{f}_{L^2(I,H^{-1}(\Omega))}+\|y_0\|_{L^2(\Omega)} \leq \frac{C}{T^{1/4}}.
\ee
...
\|\partial_t y\|_{L^2(I,\mathcal V^*)}\leq C(y_0,f,\gamma).
\end{equation}
for some $C>0$.  
\end{corollary}
\begin{proof}
