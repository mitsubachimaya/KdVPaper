...
\end{numcases}{}
\end{subequations}
where $\gamma\geq0$ is assumed. We denote by $A\colon L^2(\Omega)\rightarrow L^2(\Omega)$ the linear differential operator
\[
