...
\be
J_{N,N_{T}}(\mathbf{y}_{0}, \ldots, \mathbf{y}_{N_{T}}, \mathbf{u}_{0}, \ldots, \mathbf{u}_{N_{T}}) = \frac{1}{2}\sum_{i=1}^{N_{T}}{\Delta t \mathbf{y}_{i}^{t}M \mathbf{y}_{i}} + \alpha \sum_{j=1}^N{\left( \sum_{i = 1}^{N_T}{\Delta t u_{ji}^2}\right)^{1/2}}
\ee

This allows also to define a discrete Lagrangian and derive the discrete adjoint in the case of terminal observations
 \bealn
