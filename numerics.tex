...
\ee
More details on the computation of the inner product and various norms involved in the numerical optimization problem are to be found in section \ref{masslumping}.
