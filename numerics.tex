...
& M \mathbf{y}_{N_{T}+1} = \frac{1}{2}\left( M \mathbf{y}_{N_{T}} + M \mathbf{y}_{N_{T}-1} \right)+ \frac{1}{2}\Delta t \left(P + \gamma Q \right)\mathbf{y}_{N_{T}} + \frac{1}{2}\Delta t F(\mathbf{y}_{N_{T}}) - \frac{1}{2}\Delta t S \mathbf{y}_{N_{T}-1}
\eealn
...
\caption{Spatial support of the control, determined by $\norm{p_{\reg}}_{L^2(0,T)} = \alpha$, for $\rg = 10^{-5}$.}
\label{supportIP}
\end{figure}
