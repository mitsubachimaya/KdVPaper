...
Let $(y,u)$ $\in L^4(I,L^4(\Omega))\cap H^{1}(I,\mathcal{V}^{*})\times \M$ such that $y(T,\cdot)$ exists and is additionaly in $L^2(\Omega)$. They are called a \textit{state-control pair} if they satisfy the equation
...
\begin{prop}\label{statecontrolestimate}
 Let $(y,u)$ $\in L^4(I,L^4(\Omega))\times \M$ be a state-control pair. Then $ y\in \mathcal{B} \cap H^{1}(I,\mathcal{V}^{*})$ is a weak solution of \eqref{kdvcontrol1} - \eqref{kdvcontrol3} in the sense of Definition~\ref{defnlkdv} for $\gamma = 0$ and satisfies the global estimate
 \be
