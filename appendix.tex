...
\begin{proof}[Proof linear estimate \eqref{linestimate_regular}]
  ...
  \frac{1}{2}\frac{d}{dt}\int_{0}^{L}{(1+x)y^{2}dx} +(\frac{1}{2}+\gamma)\int_{0}^{L}{(\partial_{x}y)^{2}} \leq \left(   \frac{1+L^{2}}{2}\right)\norm{f}_{H^{-1}(\Omega)}^{2} + \frac{1}{2}\int_{0}^{L}{y^{2}dx}.
  \ee
   To facilitate the next computations, we add a non-negative term on the right
   \be
  \frac{1}{2}\frac{d}{dt}\int_{0}^{L}{(1+x)y^{2}dx} + (\frac{1}{2}+\gamma)\int_{0}^{L}{(\partial_{x}y)^{2}} \leq \left(    \frac{1+L^{2}}{2}\right)\norm{f}_{H^{-1}(\Omega)}^{2} +  \frac{1}{2}\int_{0}^{L}{(1+x)y^{2}dx}.
  \ee
  Then we can follow a Gronwall strategy, multiplying by $e^{-t}$
  \beal
  \frac{d}{dt}\left(e^{-t}\frac{1}{2}\int_{0}^{L}{(1+x)y^{2}dx}\right) + e^{-t}\left(\frac{1}{2}+\gamma\right)\int_{0}^{L}{(\partial_{x}y)^{2}} \leq
  e^{-t}\left( \frac{1+L^{2}}{2}\right)\norm{f}_{H^{-1}(\Omega)}^{2}
  \eeal
  After integration between $0$ and $t$ we have
  \beal
  ...
  & + \frac{1}{2}e^{t}\int_{0}^{L}{(1+L)y_{0}^{2}dx},
  \eeal
